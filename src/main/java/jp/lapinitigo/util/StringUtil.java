...
public final class StringUtil {
    ...
    static Map<String, String> furiganaMap;
    
    static {
        furiganaMap = new HashMap<String, String>(){
            private static final long serialVersionUID = 1L;
        {
            ...
            put("huxa","fa");put("huxi","fi");put("huxe","fe");put("huxe","fo");
	...
	public static final String paddingToBefore(String value, int length, char paddingChar) {
	...
	public static final String leftTrimBySpecifiedChar(String str, char trimChar) {
